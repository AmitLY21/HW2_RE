...
public class Activity_Menu extends AppCompatActivity {
    ...
    /**
     *  the state will change depending on the id of the user , the 7 char of the id is the state index of the data
     *  the data: California,Texas,Florida,New York,Illinois,Pennsylvania,Ohio,Washington,Michigan,Arizona
     */
    public void startGame(String id, String data) {
        if (checkID(id)) {
            String state = data.split(",")[Integer.valueOf(String.valueOf(id.charAt(7))).intValue()];
            Log.d("pttt", "Destination state: " + state + "id: " + id + "state index: " + id.charAt(7) );
